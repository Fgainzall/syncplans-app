...
export default function AcceptInvitePagePremium() {
  const router = useRouter();
  const sp = useSearchParams();

  const inviteId = useMemo(() => sp.get("invite") || "", [sp]);
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "22px 18px 56px" }}>
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            <div style={{ fontSize: 11, letterSpacing: "0.10em", textTransform: "uppercase", fontWeight: 900, opacity: 0.8 }}>
              Invitación
            </div>
            ...
            {!inviteId || !isUuid(inviteId) ? (
              ...
              <div style={{ marginTop: 12, padding: 14, borderRadius: 14, border: "1px dashed rgba(255,255,255,0.16)", opacity: 0.75 }}>
                Cargando invitación…
              </div>
            ) : !inv ? (
              <div
