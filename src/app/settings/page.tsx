          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-[11px] text-white/60">
                Usa el mismo motor de notificaciones que tu timeline: te mando a tu correo los eventos de hoy
                (personales + del grupo activo).
              </p>
            </div>
          ...
          {digestToast && (
            <div className="mt-3 rounded-xl border border-white/10 bg-black/50 px-3 py-2 text-[11px]">
              ...
              {digestToast.subtitle && (
                <div className="mt-1 text-[10px] text-white/70">{digestToast.subtitle}</div>
              )}
            </div>
          )}
        </div>
