      ...
      <main style={styles.page}>
        <div style={styles.shell}>
          ...
          <section style={styles.emptyCard}>
            ...
            <button onClick={() => router.push("/calendar")} style={styles.primaryBtnWide}>
              Ir al calendario
            </button>
          </section>
        </div>
      ...
      <div style={styles.shell}>
        ...
        <section style={styles.compareGrid}>
          ...
          >
            ...
            <div style={styles.time}>{a ? prettyTimeRange(a.start, a.end) : ""}</div>
          </div>
          ...
          >
            ...
            <div style={styles.time}>{b ? prettyTimeRange(b.start, b.end) : ""}</div>
          </div>
        </section>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  actionsTop: { display: "flex", flexDirection: "column", gap: 6, marginBottom: 10 },
